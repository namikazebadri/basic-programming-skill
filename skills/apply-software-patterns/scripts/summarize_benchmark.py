#!/usr/bin/env python3
"""Summarize a benchmark CSV created from the pattern skill eval prompts."""
...
def main() -> int:
    ...
    for agent in sorted(by_agent):
        ...
        print(f"- {agent}: avg={average(scores):.2f} prompts={len(scores)}")
